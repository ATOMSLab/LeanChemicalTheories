...
We defined gravitational acceleration (g), coefficient of thermal expansion β, kinematic viscosity (ν),
surfact temperature (T_s), bulk temperature (T_inf), thermal diffusivity (α) to demonstrate Grashof and Prandtl
